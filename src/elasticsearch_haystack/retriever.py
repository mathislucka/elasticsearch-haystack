...
class ElasticsearchRetriever:
    """
    A component for retrieving documents from an ElasticsearchDocumentStore.
    """

    def __init__(
        self, document_store: ElasticsearchDocumentStore, filters: Optional[Dict[str, Any]] = None, top_k: int = 10
    ):
        """
        Create an ElasticsearchRetriever component. Usually you pass some basic configuration
